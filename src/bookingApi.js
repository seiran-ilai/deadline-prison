...
export async function createBooking(sessionId, { note = null, game_name = null, avatar_url = null, password = null } = {}) {
  ...
  const res = await fetch('/api/booking', {
    ...
    body: JSON.stringify({ session_id: sessionId, note: note || null, game_name: game_name || null, avatar_url: avatar_url || null, password: password || null }),
  })
